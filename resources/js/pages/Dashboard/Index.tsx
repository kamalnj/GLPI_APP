        ...
        {total_machines === 0 ? (
          ...
          >
            ...
            <TabsContent value="software" className="space-y-8">
              ...
              <section>
                {software_stats &&
                software_stats.devices_above_average_with_low_disk.length > 0 ? (
                  <DevicesWithLowDisk
                    devices={
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle>
                        Machines avec faible espace disque
                      </CardTitle>
                    </CardHeader>
            ...
            <TabsContent value="groups" className="space-y-8">
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                ...
                <div className="transition-all duration-300 hover:scale-[1.02]">
                  ...
                  groups_stats.low_disk_by_groupe.length > 0 ? (
                    <LowDiskDevicesByGroupeChart
                      data={groups_stats.low_disk_by_groupe}
                    />
                  ) : groups_stats !== null ? (
                    <Card>
                      <CardHeader>
                        <CardTitle>
                          Appareils avec faible espace disque
                        </CardTitle>
                      </CardHeader>
                ...
                <div className="transition-all duration-300 hover:scale-[1.02]">
                  ...
                  groups_stats.top_groups_vulnerabilities.length > 0 ? (
                    <TopGroupsVulnerabilitiesChart
                      data={
                        groups_stats.top_groups_vulnerabilities
                      }
                ...
                <div className="transition-all duration-300 hover:scale-[1.02] xl:col-span-2">
                  ...
                  groups_stats.top_groups_softwares.length > 0 ? (
                    <TopGroupsSoftwaresChart
                      data={groups_stats.top_groups_softwares}
                    />
                  ) : (
                    <ChartSkeleton />
                  )}
            ...
            <TabsContent value="collaborators" className="space-y-8">
              ...
              <section>
                {collaborators_stats ? (
                  <RemoteOnsiteAverage
                    onsite_percent={
                      collaborators_stats.remote_onsite_average.onsite_percent
                    }
                    remote_percent={
                      collaborators_stats.remote_onsite_average.remote_percent
                    }
                    onsite_avg_hours={
                      collaborators_stats.remote_onsite_average.onsite_avg_hours
                    }
                    remote_avg_hours={
                      collaborators_stats.remote_onsite_average.remote_avg_hours
                    }
                  />
                ) : (
                  <ChartSkeleton />
              ...
              <section>
                {collaborators_stats ? (
                  <TopActiveUsers
                    users={collaborators_stats.top_active_users}
                  />
                ) : (
                  <ChartSkeleton />
                )}
              ...
              <section>
                {collaborators_stats ? (
                  <TopUnlocksUsers
                    users={collaborators_stats.top_unlocks_users}
                  />
                ) : (
                  <ChartSkeleton />
                )}
              ...
              <section>
                {collaborators_stats ? (
                  <InactiveUsers
                    users={collaborators_stats.inactive_users}
                  />
                ) : (
                  <ChartSkeleton />
                )}
