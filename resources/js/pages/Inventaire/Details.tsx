...
import SidebarNav, {
    type Section,
} from '@/components/inventaire/Details/SidebarNav';
import {
    OsSection,
    CpuSection,
    RamSection,
} from '@/components/inventaire/Details/HardwareSections';
...
export default function Details({ computer }: PageProps) {
    ...
    const [chartView, setChartView] = useState<'current' | 'previous'>(
        'current',
    );
    ...
    const sections: Section[] = [
        ...
        { id: 'ram', title: 'Mémoire RAM', icon: <FiDatabase size={15} /> },
        {
            ...
            count: computer.volumes.length,
        },
        {
            id: 'antivirus',
            title: 'Antivirus',
            icon: <FiShield size={15} />,
            count: computer.antiviruses.length,
        },
        {
            id: 'vulnerabilities',
            title: 'Vulnérabilités',
            icon: <FiAlertTriangle size={15} />,
            count: computer.security_kpis.total,
        },
        {
            id: 'softwares',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-4 p-3 sm:gap-6 sm:p-6">
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:gap-6">
                    ...
                    <div
                        className="section-fade min-w-0 flex-1"
                        key={activeSection}
                    >
