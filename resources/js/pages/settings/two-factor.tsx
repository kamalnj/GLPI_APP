    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <h1 className="sr-only">
                Paramètres de l’authentification à deux facteurs
            </h1>
                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                vous devrez saisir un code sécurisé lors de la connexion.
                                Ce code est généré par une application compatible TOTP
                                sur votre téléphone.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                Ce code peut être obtenu via une application compatible
