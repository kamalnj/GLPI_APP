...
export function DevicesWithLowDisk({ devices }: DevicesWithLowDiskProps) {
  if (!devices || devices.length === 0) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Appareils en alerte (Au-dessus moyenne + disque faible)</CardTitle>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card className="border-red-200">
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <span className="text-2xl font-bold text-red-600">{devices.length}</span>
      </CardHeader>
      <CardContent>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">Logiciels</TableHead>
                <TableHead className="text-right">Espace libre</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
